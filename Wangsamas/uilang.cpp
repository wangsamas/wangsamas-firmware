...
#if LANGUAGE_EN_ACTIVE+LANGUAGE_DE_ACTIVE+LANGUAGE_ES_ACTIVE+LANGUAGE_PT_ACTIVE+LANGUAGE_FR_ACTIVE+LANGUAGE_NL_ACTIVE+LANGUAGE_IT_ACTIVE+LANGUAGE_SE_ACTIVE+LANGUAGE_CZ_ACTIVE+LANGUAGE_PL_ACTIVE+LANGUAGE_TR_ACTIVE+LANGUAGE_IN_ACTIVE < 1 // Indonesia
...
TRANS(UI_TEXT_X_ANGLE_POS_EN); // Kusuma SCARA
TRANS(UI_TEXT_Y_ANGLE_POS_EN);
TRANS(UI_TEXT_X_ANGLE_FAST_EN);
TRANS(UI_TEXT_Y_ANGLE_FAST_EN);
TRANS(UI_TEXT_ACTION_XROTATION4A_EN);
TRANS(UI_TEXT_ACTION_XROTATION4B_EN);
TRANS(UI_TEXT_ACTION_XROTATION4C_EN);
TRANS(UI_TEXT_ACTION_XROTATION4D_EN);
TRANS(UI_TEXT_ACTION_YROTATION4A_EN);
TRANS(UI_TEXT_ACTION_YROTATION4B_EN);
TRANS(UI_TEXT_ACTION_YROTATION4C_EN);
TRANS(UI_TEXT_ACTION_YROTATION4D_EN);
TRANS(UI_TEXT_ACTION_XFAST_ROTATION4A_EN);
TRANS(UI_TEXT_ACTION_XFAST_ROTATION4B_EN);
TRANS(UI_TEXT_ACTION_XFAST_ROTATION4C_EN);
TRANS(UI_TEXT_ACTION_XFAST_ROTATION4D_EN);
TRANS(UI_TEXT_ACTION_YFAST_ROTATION4A_EN);
TRANS(UI_TEXT_ACTION_YFAST_ROTATION4B_EN);
TRANS(UI_TEXT_ACTION_YFAST_ROTATION4C_EN);
TRANS(UI_TEXT_ACTION_YFAST_ROTATION4D_EN);
TRANS(UI_TEXT_ACTION_XROTATION2A_EN);
TRANS(UI_TEXT_ACTION_XROTATION2B_EN);
TRANS(UI_TEXT_ACTION_YROTATION2A_EN);
TRANS(UI_TEXT_ACTION_YROTATION2B_EN);
TRANS(UI_TEXT_ACTION_XFAST_ROTATION2A_EN);
TRANS(UI_TEXT_ACTION_XFAST_ROTATION2B_EN);
TRANS(UI_TEXT_ACTION_YFAST_ROTATION2A_EN);
TRANS(UI_TEXT_ACTION_YFAST_ROTATION2B_EN);
TRANS(UI_TEXT_SHOULDER_CALIB_EN);
TRANS(UI_TEXT_ELBOW_CALIB_EN);
TRANS(UI_TEXT_SET_SHOULDER_ORIGIN_EN);
TRANS(UI_TEXT_SET_ELBOW_ORIGIN_EN);
TRANS(UI_TEXT_CLOSE_ARM_EN);
TRANS(UI_TEXT_BED_POS_EN);
TRANS(UI_TEXT_STEP_CAL_EN);
TRANS(UI_TEXT_BED_OFF_EN);
TRANS(UI_TEXT_MOVEX_EN);
TRANS(UI_TEXT_MOVEY_EN);
TRANS(UI_TEXT_MOVEZ_EN);
TRANS(UI_TEXT_ROTX_EN);
TRANS(UI_TEXT_ROTY_EN);
TRANS(UI_TEXT_ENDSTOP_X_EN);
TRANS(UI_TEXT_ENDSTOP_Y_EN);
TRANS(UI_TEXT_SET_BED_CENTER_EN);
TRANS(UI_TEXT_X_STEP_EN);
TRANS(UI_TEXT_Y_STEP_EN);
TRANS(UI_TEXT_Z_STEP_EN);
TRANS(UI_TEXT_E_STEP_EN);
TRANS(UI_TEXT_SWITCH_OFF_EN);
TRANS(UI_TEXT_MOVE_EN);
TRANS(UI_TEXT_PREHEAT_EN);
TRANS(UI_TEXT_ADJ_MENU_EN);
TRANS(UI_TEXT_FILM_MENU_EN);
TRANS(UI_TEXT_TEMP_EN);
...
PGM_P const translations_en[NUM_TRANSLATED_WORDS] PROGMEM = {
 ...
 FUI_TEXT_DBG_ENDSTOP_EN, // Kusuma SCARA
 FUI_TEXT_X_ANGLE_POS_EN,
 FUI_TEXT_Y_ANGLE_POS_EN,
 FUI_TEXT_X_ANGLE_FAST_EN,
 FUI_TEXT_Y_ANGLE_FAST_EN,
 FUI_TEXT_ACTION_XROTATION4A_EN,
 FUI_TEXT_ACTION_XROTATION4B_EN,
 FUI_TEXT_ACTION_XROTATION4C_EN,
 FUI_TEXT_ACTION_XROTATION4D_EN,
 FUI_TEXT_ACTION_YROTATION4A_EN,
 FUI_TEXT_ACTION_YROTATION4B_EN,
 FUI_TEXT_ACTION_YROTATION4C_EN,
 FUI_TEXT_ACTION_YROTATION4D_EN,
 FUI_TEXT_ACTION_XFAST_ROTATION4A_EN,
 FUI_TEXT_ACTION_XFAST_ROTATION4B_EN,
 FUI_TEXT_ACTION_XFAST_ROTATION4C_EN,
 FUI_TEXT_ACTION_XFAST_ROTATION4D_EN,
 FUI_TEXT_ACTION_YFAST_ROTATION4A_EN,
 FUI_TEXT_ACTION_YFAST_ROTATION4B_EN,
 FUI_TEXT_ACTION_YFAST_ROTATION4C_EN,
 FUI_TEXT_ACTION_YFAST_ROTATION4D_EN,
 FUI_TEXT_ACTION_XROTATION2A_EN,
 FUI_TEXT_ACTION_XROTATION2B_EN,
 FUI_TEXT_ACTION_YROTATION2A_EN,
 FUI_TEXT_ACTION_YROTATION2B_EN,
 FUI_TEXT_ACTION_XFAST_ROTATION2A_EN,
 FUI_TEXT_ACTION_XFAST_ROTATION2B_EN,
 FUI_TEXT_ACTION_YFAST_ROTATION2A_EN,
 FUI_TEXT_ACTION_YFAST_ROTATION2B_EN,
 FUI_TEXT_SHOULDER_CALIB_EN,
 FUI_TEXT_ELBOW_CALIB_EN,
 FUI_TEXT_SET_SHOULDER_ORIGIN_EN,
 FUI_TEXT_SET_ELBOW_ORIGIN_EN,
 FUI_TEXT_CLOSE_ARM_EN,
 FUI_TEXT_BED_POS_EN,
 FUI_TEXT_STEP_CAL_EN,
 FUI_TEXT_BED_OFF_EN,
 FUI_TEXT_MOVEX_EN,
 FUI_TEXT_MOVEY_EN,
 FUI_TEXT_MOVEZ_EN,
 FUI_TEXT_ROTX_EN,
 FUI_TEXT_ROTY_EN,
 FUI_TEXT_ENDSTOP_X_EN,
 FUI_TEXT_ENDSTOP_Y_EN,
 FUI_TEXT_SET_BED_CENTER_EN,
 FUI_TEXT_X_STEP_EN,
 FUI_TEXT_Y_STEP_EN,
 FUI_TEXT_Z_STEP_EN,
 FUI_TEXT_E_STEP_EN,
 FUI_TEXT_SWITCH_OFF_EN,
 FUI_TEXT_MOVE_EN,
 FUI_TEXT_PREHEAT_EN,
 FUI_TEXT_ADJ_MENU_EN,
 FUI_TEXT_FILM_MENU_EN,
 FUI_TEXT_TEMP_EN
};
...
TRANS(UI_TEXT_ON_IN);
TRANS(UI_TEXT_OFF_IN);
TRANS(UI_TEXT_NA_IN);
TRANS(UI_TEXT_YES_IN);
TRANS(UI_TEXT_NO_IN);
TRANS(UI_TEXT_PRINT_POS_IN);
TRANS(UI_TEXT_PRINTING_IN);
TRANS(UI_TEXT_IDLE_IN);
TRANS(UI_TEXT_NOSDCARD_IN);
TRANS(UI_TEXT_ERROR_IN);
TRANS(UI_TEXT_BACK_IN);
TRANS(UI_TEXT_SPEED_MENU_IN);
TRANS(UI_TEXT_ERRORMSG_IN);
TRANS(UI_TEXT_CONFIGURATION_IN);
TRANS(UI_TEXT_POSITION_IN);
TRANS(UI_TEXT_EXTRUDER_IN);
TRANS(UI_TEXT_SD_CARD_IN);
TRANS(UI_TEXT_DEBUGGING_IN);
TRANS(UI_TEXT_HOME_DELTA_IN);
TRANS(UI_TEXT_HOME_ALL_IN);
TRANS(UI_TEXT_HOME_X_IN);
TRANS(UI_TEXT_HOME_Y_IN);
TRANS(UI_TEXT_HOME_Z_IN);
TRANS(UI_TEXT_PREHEAT_PLA_IN);
TRANS(UI_TEXT_PREHEAT_ABS_IN);
TRANS(UI_TEXT_LIGHTS_ONOFF_IN);
TRANS(UI_TEXT_COOLDOWN_IN);
TRANS(UI_TEXT_SET_TO_ORIGIN_IN);
TRANS(UI_TEXT_DISABLE_STEPPER_IN);
TRANS(UI_TEXT_X_POSITION_IN);
TRANS(UI_TEXT_X_POS_FAST_IN);
TRANS(UI_TEXT_Y_POSITION_IN);
TRANS(UI_TEXT_Y_POS_FAST_IN);
TRANS(UI_TEXT_Z_POSITION_IN);
TRANS(UI_TEXT_Z_POS_FAST_IN);
TRANS(UI_TEXT_E_POSITION_IN);
TRANS(UI_TEXT_BED_TEMP_IN);
TRANS(UI_TEXT_EXTR0_TEMP_IN);
TRANS(UI_TEXT_EXTR1_TEMP_IN);
TRANS(UI_TEXT_EXTR2_TEMP_IN);
TRANS(UI_TEXT_EXTR0_OFF_IN);
TRANS(UI_TEXT_EXTR1_OFF_IN);
TRANS(UI_TEXT_EXTR2_OFF_IN);
TRANS(UI_TEXT_EXTR0_SELECT_IN);
TRANS(UI_TEXT_EXTR1_SELECT_IN);
TRANS(UI_TEXT_EXTR2_SELECT_IN);
TRANS(UI_TEXT_EXTR_ORIGIN_IN);
TRANS(UI_TEXT_PRINT_X_IN);
TRANS(UI_TEXT_PRINT_Y_IN);
TRANS(UI_TEXT_PRINT_Z_IN);
TRANS(UI_TEXT_PRINT_Z_DELTA_IN);
TRANS(UI_TEXT_MOVE_X_IN);
TRANS(UI_TEXT_MOVE_Y_IN);
TRANS(UI_TEXT_MOVE_Z_IN);
TRANS(UI_TEXT_MOVE_Z_DELTA_IN);
TRANS(UI_TEXT_JERK_IN);
TRANS(UI_TEXT_ZJERK_IN);
TRANS(UI_TEXT_ACCELERATION_IN);
TRANS(UI_TEXT_STORE_TO_EEPROM_IN);
TRANS(UI_TEXT_LOAD_EEPROM_IN);
TRANS(UI_TEXT_DBG_ECHO_IN);
TRANS(UI_TEXT_DBG_INFO_IN);
TRANS(UI_TEXT_DBG_ERROR_IN);
TRANS(UI_TEXT_DBG_DRYRUN_IN);
TRANS(UI_TEXT_DBG_ENDSTOP_IN);
TRANS(UI_TEXT_OPS_OFF_IN);
TRANS(UI_TEXT_OPS_CLASSIC_IN);
TRANS(UI_TEXT_OPS_FAST_IN);
TRANS(UI_TEXT_OPS_RETRACT_IN);
TRANS(UI_TEXT_OPS_BACKSLASH_IN);
TRANS(UI_TEXT_OPS_MINDIST_IN);
TRANS(UI_TEXT_OPS_MOVE_AFTER_IN);
TRANS(UI_TEXT_ANTI_OOZE_IN);
TRANS(UI_TEXT_PRINT_FILE_IN);
TRANS(UI_TEXT_PAUSE_PRINT_IN);
TRANS(UI_TEXT_CONTINUE_PRINT_IN);
TRANS(UI_TEXT_UNMOUNT_CARD_IN);
TRANS(UI_TEXT_MOUNT_CARD_IN);
TRANS(UI_TEXT_DELETE_FILE_IN);
TRANS(UI_TEXT_FEEDRATE_IN);
TRANS(UI_TEXT_FEED_MAX_X_IN);
TRANS(UI_TEXT_FEED_MAX_Y_IN);
TRANS(UI_TEXT_FEED_MAX_Z_IN);
TRANS(UI_TEXT_FEED_MAX_Z_DELTA_IN);
TRANS(UI_TEXT_FEED_HOME_X_IN);
TRANS(UI_TEXT_FEED_HOME_Y_IN);
TRANS(UI_TEXT_FEED_HOME_Z_IN);
TRANS(UI_TEXT_FEED_HOME_Z_DELTA_IN);
TRANS(UI_TEXT_ACTION_XPOSITION4A_IN);
TRANS(UI_TEXT_ACTION_XPOSITION4B_IN);
TRANS(UI_TEXT_ACTION_XPOSITION4C_IN);
TRANS(UI_TEXT_ACTION_XPOSITION4D_IN);
TRANS(UI_TEXT_ACTION_YPOSITION4A_IN);
TRANS(UI_TEXT_ACTION_YPOSITION4B_IN);
TRANS(UI_TEXT_ACTION_YPOSITION4C_IN);
TRANS(UI_TEXT_ACTION_YPOSITION4D_IN);
TRANS(UI_TEXT_ACTION_ZPOSITION4A_IN);
TRANS(UI_TEXT_ACTION_ZPOSITION4B_IN);
TRANS(UI_TEXT_ACTION_ZPOSITION4C_IN);
TRANS(UI_TEXT_ACTION_ZPOSITION4D_IN);
TRANS(UI_TEXT_ACTION_XPOSITION_FAST4A_IN);
TRANS(UI_TEXT_ACTION_XPOSITION_FAST4B_IN);
TRANS(UI_TEXT_ACTION_XPOSITION_FAST4C_IN);
TRANS(UI_TEXT_ACTION_XPOSITION_FAST4D_IN);
TRANS(UI_TEXT_ACTION_YPOSITION_FAST4A_IN);
TRANS(UI_TEXT_ACTION_YPOSITION_FAST4B_IN);
TRANS(UI_TEXT_ACTION_YPOSITION_FAST4C_IN);
TRANS(UI_TEXT_ACTION_YPOSITION_FAST4D_IN);
TRANS(UI_TEXT_ACTION_ZPOSITION_FAST4A_IN);
TRANS(UI_TEXT_ACTION_ZPOSITION_FAST4B_IN);
TRANS(UI_TEXT_ACTION_ZPOSITION_FAST4C_IN);
TRANS(UI_TEXT_ACTION_ZPOSITION_FAST4D_IN);
TRANS(UI_TEXT_ACTION_EPOSITION_FAST2A_IN);
TRANS(UI_TEXT_ACTION_EPOSITION_FAST2B_IN);
TRANS(UI_TEXT_ACTION_XPOSITION2A_IN);
TRANS(UI_TEXT_ACTION_XPOSITION2B_IN);
TRANS(UI_TEXT_ACTION_YPOSITION2A_IN);
TRANS(UI_TEXT_ACTION_YPOSITION2B_IN);
TRANS(UI_TEXT_ACTION_ZPOSITION2A_IN);
TRANS(UI_TEXT_ACTION_ZPOSITION2B_IN);
TRANS(UI_TEXT_ACTION_XPOSITION_FAST2A_IN);
TRANS(UI_TEXT_ACTION_XPOSITION_FAST2B_IN);
TRANS(UI_TEXT_ACTION_YPOSITION_FAST2A_IN);
TRANS(UI_TEXT_ACTION_YPOSITION_FAST2B_IN);
TRANS(UI_TEXT_ACTION_ZPOSITION_FAST2A_IN);
TRANS(UI_TEXT_ACTION_ZPOSITION_FAST2B_IN);
TRANS(UI_TEXT_FANSPEED_IN);
TRANS(UI_TEXT_ACTION_FANSPEED_IN);
TRANS(UI_TEXT_FAN_OFF_IN);
TRANS(UI_TEXT_FAN_25_IN);
TRANS(UI_TEXT_FAN_50_IN);
TRANS(UI_TEXT_FAN_75_IN);
TRANS(UI_TEXT_FAN_FULL_IN);
TRANS(UI_TEXT_STEPPER_INACTIVE_IN);
TRANS(UI_TEXT_STEPPER_INACTIVE2A_IN);
TRANS(UI_TEXT_STEPPER_INACTIVE2B_IN);
TRANS(UI_TEXT_POWER_INACTIVE_IN);
TRANS(UI_TEXT_POWER_INACTIVE2A_IN);
TRANS(UI_TEXT_POWER_INACTIVE2B_IN);
TRANS(UI_TEXT_GENERAL_IN);
TRANS(UI_TEXT_BAUDRATE_IN);
TRANS(UI_TEXT_EXTR_STEPS_IN);
TRANS(UI_TEXT_EXTR_START_FEED_IN);
TRANS(UI_TEXT_EXTR_MAX_FEED_IN);
TRANS(UI_TEXT_EXTR_ACCEL_IN);
TRANS(UI_TEXT_EXTR_WATCH_IN);
TRANS(UI_TEXT_EXTR_ADVANCE_L_IN);
TRANS(UI_TEXT_EXTR_ADVANCE_K_IN);
TRANS(UI_TEXT_EXTR_MANAGER_IN);
TRANS(UI_TEXT_EXTR_PGAIN_IN);
TRANS(UI_TEXT_EXTR_DEADTIME_IN);
TRANS(UI_TEXT_EXTR_DMAX_DT_IN);
TRANS(UI_TEXT_EXTR_IGAIN_IN);
TRANS(UI_TEXT_EXTR_DGAIN_IN);
TRANS(UI_TEXT_EXTR_DMIN_IN);
TRANS(UI_TEXT_EXTR_DMAX_IN);
TRANS(UI_TEXT_EXTR_PMAX_IN);
TRANS(UI_TEXT_EXTR_XOFF_IN);
TRANS(UI_TEXT_EXTR_YOFF_IN);
TRANS(UI_TEXT_STRING_HM_BANGBANG_IN);
TRANS(UI_TEXT_STRING_HM_PID_IN);
TRANS(UI_TEXT_STRING_ACTION_IN);
TRANS(UI_TEXT_HEATING_EXTRUDER_IN);
TRANS(UI_TEXT_HEATING_BED_IN);
TRANS(UI_TEXT_KILLED_IN);
TRANS(UI_TEXT_STEPPER_DISABLED_IN);
TRANS(UI_TEXT_EEPROM_STOREDA_IN);
TRANS(UI_TEXT_EEPROM_STOREDB_IN);
TRANS(UI_TEXT_EEPROM_LOADEDA_IN);
TRANS(UI_TEXT_EEPROM_LOADEDB_IN);
TRANS(UI_TEXT_UPLOADING_IN);
TRANS(UI_TEXT_PAGE_BUFFER_IN);
TRANS(UI_TEXT_PAGE_EXTRUDER_IN);
TRANS(UI_TEXT_PAGE_EXTRUDER1_IN);
TRANS(UI_TEXT_PAGE_EXTRUDER2_IN);
TRANS(UI_TEXT_PAGE_EXTRUDER3_IN);
TRANS(UI_TEXT_PAGE_BED_IN);
TRANS(UI_TEXT_SPEED_MULTIPLY_IN);
TRANS(UI_TEXT_FLOW_MULTIPLY_IN);
TRANS(UI_TEXT_SHOW_MEASUREMENT_IN);
TRANS(UI_TEXT_RESET_MEASUREMENT_IN);
TRANS(UI_TEXT_SET_MEASURED_ORIGIN_IN);
TRANS(UI_TEXT_ZCALIB_IN);
TRANS(UI_TEXT_SET_P1_IN);
TRANS(UI_TEXT_SET_P2_IN);
TRANS(UI_TEXT_SET_P3_IN);
TRANS(UI_TEXT_CALCULATE_LEVELING_IN);
TRANS(UI_TEXT_LEVEL_IN);
TRANS(UI_TEXT_EXTR_WAIT_RETRACT_TEMP_IN);
TRANS(UI_TEXT_EXTR_WAIT_RETRACT_UNITS_IN);
TRANS(UI_TEXT_SD_REMOVED_IN);
TRANS(UI_TEXT_SD_INSERTED_IN);
TRANS(UI_TEXT_PRINTER_READY_IN);
TRANS(UI_TEXT_PRINTTIME_DAYS_IN);
TRANS(UI_TEXT_PRINTTIME_HOURS_IN);
TRANS(UI_TEXT_PRINTTIME_MINUTES_IN);
TRANS(UI_TEXT_PRINT_TIME_IN);
TRANS(UI_TEXT_PRINT_FILAMENT_IN);
TRANS(UI_TEXT_PRINTED_IN);
TRANS(UI_TEXT_POWER_IN);
TRANS(UI_TEXT_STRING_HM_DEADTIME_IN);
TRANS(UI_TEXT_STRING_HM_SLOWBANG_IN);
TRANS(UI_TEXT_STOP_PRINT_IN);
TRANS(UI_TEXT_Z_BABYSTEPPING_IN);
TRANS(UI_TEXT_CHANGE_FILAMENT_IN);
TRANS(UI_TEXT_WIZ_CH_FILAMENT1_IN);
TRANS(UI_TEXT_WIZ_CH_FILAMENT2_IN);
TRANS(UI_TEXT_WIZ_CH_FILAMENT3_IN);
TRANS(UI_TEXT_CLICK_DONE_IN);
TRANS(UI_TEXT_AUTOLEVEL_ONOFF_IN);
TRANS(UI_TEXT_SERVOPOS_IN);
TRANS(UI_TEXT_IGNORE_M106_IN);
TRANS(UI_TEXT_WIZ_REHEAT1_IN);
TRANS(UI_TEXT_WIZ_REHEAT2_IN);
TRANS(UI_TEXT_WIZ_WAITTEMP1_IN);
TRANS(UI_TEXT_WIZ_WAITTEMP2_IN);
TRANS(UI_TEXT_EXTRUDER_JAM_IN);
TRANS(UI_TEXT_STANDBY_IN);
TRANS(UI_TEXT_BED_COATING_IN);
TRANS(UI_TEXT_BED_COATING_SET1_IN);
TRANS(UI_TEXT_BED_COATING_SET2_IN);
TRANS(UI_TEXT_NOCOATING_IN);
TRANS(UI_TEXT_BUILDTAK_IN);
TRANS(UI_TEXT_KAPTON_IN);
TRANS(UI_TEXT_BLUETAPE_IN);
TRANS(UI_TEXT_PETTAPE_IN);
TRANS(UI_TEXT_GLUESTICK_IN);
TRANS(UI_TEXT_CUSTOM_IN);
TRANS(UI_TEXT_COATING_CUSTOM_IN);
TRANS(UI_TEXT_LANGUAGE_IN);
TRANS(UI_TEXT_MAINPAGE6_1_IN);
TRANS(UI_TEXT_MAINPAGE6_2_IN);
TRANS(UI_TEXT_MAINPAGE6_3_IN);
TRANS(UI_TEXT_MAINPAGE6_4_IN);
TRANS(UI_TEXT_MAINPAGE6_5_IN);
TRANS(UI_TEXT_MAINPAGE6_6_IN);
TRANS(UI_TEXT_MAINPAGE_TEMP_BED_IN);
TRANS(UI_TEXT_MAINPAGE_BED_IN);
TRANS(UI_TEXT_MAINPAGE_Z_BUF_IN);
TRANS(UI_TEXT_MAINPAGE_MUL_EUSAGE_IN);
TRANS(UI_TEXT_MAINPAGE_XY_IN);
TRANS(UI_TEXT_PRINT_TIME_VALUE_IN);
TRANS(UI_TEXT_PRINT_FILAMENT_VALUE_IN);
TRANS(UI_TEXT_METER_PRINTED_IN);
TRANS(UI_TEXT_STATUS_IN);
TRANS(UI_TEXT_EMPTY_IN);
TRANS(UI_TEXT_TEMP_SET_IN);
TRANS(UI_TEXT_CURRENT_TEMP_IN);
TRANS(UI_TEXT_COATING_THICKNESS_IN);
TRANS(UI_TEXT_EXTR3_TEMP_IN);
TRANS(UI_TEXT_EXTR4_TEMP_IN);
TRANS(UI_TEXT_EXTR5_TEMP_IN);
TRANS(UI_TEXT_EXTR3_OFF_IN);
TRANS(UI_TEXT_EXTR4_OFF_IN);
TRANS(UI_TEXT_EXTR5_OFF_IN);
TRANS(UI_TEXT_EXTR3_SELECT_IN);
TRANS(UI_TEXT_EXTR4_SELECT_IN);
TRANS(UI_TEXT_EXTR5_SELECT_IN);
TRANS(UI_TEXT_DITTO_0_IN);
TRANS(UI_TEXT_DITTO_1_IN);
TRANS(UI_TEXT_DITTO_2_IN);
TRANS(UI_TEXT_DITTO_3_IN);
TRANS(UI_TEXT_ZPROBE_HEIGHT_IN);
TRANS(UI_TEXT_OFFSETS_IN);
TRANS(UI_TEXT_X_OFFSET_IN);
TRANS(UI_TEXT_Y_OFFSET_IN);
TRANS(UI_TEXT_Z_OFFSET_IN);
TRANS(UI_TEXT_X_ANGLE_POS_IN); // Kusuma SCARA
TRANS(UI_TEXT_Y_ANGLE_POS_IN);
TRANS(UI_TEXT_X_ANGLE_FAST_IN);
TRANS(UI_TEXT_Y_ANGLE_FAST_IN);
TRANS(UI_TEXT_ACTION_XROTATION4A_IN);
TRANS(UI_TEXT_ACTION_XROTATION4B_IN);
TRANS(UI_TEXT_ACTION_XROTATION4C_IN);
TRANS(UI_TEXT_ACTION_XROTATION4D_IN);
TRANS(UI_TEXT_ACTION_YROTATION4A_IN);
TRANS(UI_TEXT_ACTION_YROTATION4B_IN);
TRANS(UI_TEXT_ACTION_YROTATION4C_IN);
TRANS(UI_TEXT_ACTION_YROTATION4D_IN);
TRANS(UI_TEXT_ACTION_XFAST_ROTATION4A_IN);
TRANS(UI_TEXT_ACTION_XFAST_ROTATION4B_IN);
TRANS(UI_TEXT_ACTION_XFAST_ROTATION4C_IN);
TRANS(UI_TEXT_ACTION_XFAST_ROTATION4D_IN);
TRANS(UI_TEXT_ACTION_YFAST_ROTATION4A_IN);
TRANS(UI_TEXT_ACTION_YFAST_ROTATION4B_IN);
TRANS(UI_TEXT_ACTION_YFAST_ROTATION4C_IN);
TRANS(UI_TEXT_ACTION_YFAST_ROTATION4D_IN);
TRANS(UI_TEXT_ACTION_XROTATION2A_IN);
TRANS(UI_TEXT_ACTION_XROTATION2B_IN);
TRANS(UI_TEXT_ACTION_YROTATION2A_IN);
TRANS(UI_TEXT_ACTION_YROTATION2B_IN);
TRANS(UI_TEXT_ACTION_XFAST_ROTATION2A_IN);
TRANS(UI_TEXT_ACTION_XFAST_ROTATION2B_IN);
TRANS(UI_TEXT_ACTION_YFAST_ROTATION2A_IN);
TRANS(UI_TEXT_ACTION_YFAST_ROTATION2B_IN);
TRANS(UI_TEXT_SHOULDER_CALIB_IN);
TRANS(UI_TEXT_ELBOW_CALIB_IN);
TRANS(UI_TEXT_SET_SHOULDER_ORIGIN_IN);
TRANS(UI_TEXT_SET_ELBOW_ORIGIN_IN);
TRANS(UI_TEXT_CLOSE_ARM_IN);
TRANS(UI_TEXT_BED_POS_IN);
TRANS(UI_TEXT_STEP_CAL_IN);
TRANS(UI_TEXT_BED_OFF_IN);
TRANS(UI_TEXT_MOVEX_IN);
TRANS(UI_TEXT_MOVEY_IN);
TRANS(UI_TEXT_MOVEZ_IN);
TRANS(UI_TEXT_ROTX_IN);
TRANS(UI_TEXT_ROTY_IN);
TRANS(UI_TEXT_ENDSTOP_X_IN);
TRANS(UI_TEXT_ENDSTOP_Y_IN);
TRANS(UI_TEXT_SET_BED_CENTER_IN);
TRANS(UI_TEXT_X_STEP_IN);
TRANS(UI_TEXT_Y_STEP_IN);
TRANS(UI_TEXT_Z_STEP_IN);
TRANS(UI_TEXT_E_STEP_IN);
TRANS(UI_TEXT_SWITCH_OFF_IN);
TRANS(UI_TEXT_MOVE_IN);
TRANS(UI_TEXT_PREHEAT_IN);
TRANS(UI_TEXT_ADJ_MENU_IN);
TRANS(UI_TEXT_FILM_MENU_IN);
TRANS(UI_TEXT_TEMP_IN);

PGM_P const translations_in[NUM_TRANSLATED_WORDS] PROGMEM = {
 FUI_TEXT_ON_IN,
 FUI_TEXT_OFF_IN,
 FUI_TEXT_NA_IN,
 FUI_TEXT_YES_IN,
 FUI_TEXT_NO_IN,
 FUI_TEXT_PRINT_POS_IN,
 FUI_TEXT_PRINTING_IN,
 FUI_TEXT_IDLE_IN,
 FUI_TEXT_NOSDCARD_IN,
 FUI_TEXT_ERROR_IN,
 FUI_TEXT_BACK_IN,
 FUI_TEXT_SPEED_MENU_IN,
 FUI_TEXT_ERRORMSG_IN,
 FUI_TEXT_CONFIGURATION_IN,
 FUI_TEXT_POSITION_IN,
 FUI_TEXT_EXTRUDER_IN,
 FUI_TEXT_SD_CARD_IN,
 FUI_TEXT_DEBUGGING_IN,
 FUI_TEXT_HOME_DELTA_IN,
 FUI_TEXT_HOME_ALL_IN,
 FUI_TEXT_HOME_X_IN,
 FUI_TEXT_HOME_Y_IN,
 FUI_TEXT_HOME_Z_IN,
 FUI_TEXT_PREHEAT_PLA_IN,
 FUI_TEXT_PREHEAT_ABS_IN,
 FUI_TEXT_LIGHTS_ONOFF_IN,
 FUI_TEXT_COOLDOWN_IN,
 FUI_TEXT_SET_TO_ORIGIN_IN,
 FUI_TEXT_DISABLE_STEPPER_IN,
 FUI_TEXT_X_POSITION_IN,
 FUI_TEXT_X_POS_FAST_IN,
 FUI_TEXT_Y_POSITION_IN,
 FUI_TEXT_Y_POS_FAST_IN,
 FUI_TEXT_Z_POSITION_IN,
 FUI_TEXT_Z_POS_FAST_IN,
 FUI_TEXT_E_POSITION_IN,
 FUI_TEXT_BED_TEMP_IN,
 FUI_TEXT_EXTR0_TEMP_IN,
 FUI_TEXT_EXTR1_TEMP_IN,
 FUI_TEXT_EXTR2_TEMP_IN,
 FUI_TEXT_EXTR0_OFF_IN,
 FUI_TEXT_EXTR1_OFF_IN,
 FUI_TEXT_EXTR2_OFF_IN,
 FUI_TEXT_EXTR0_SELECT_IN,
 FUI_TEXT_EXTR1_SELECT_IN,
 FUI_TEXT_EXTR2_SELECT_IN,
 FUI_TEXT_EXTR_ORIGIN_IN,
 FUI_TEXT_PRINT_X_IN,
 FUI_TEXT_PRINT_Y_IN,
 FUI_TEXT_PRINT_Z_IN,
 FUI_TEXT_PRINT_Z_DELTA_IN,
 FUI_TEXT_MOVE_X_IN,
 FUI_TEXT_MOVE_Y_IN,
 FUI_TEXT_MOVE_Z_IN,
 FUI_TEXT_MOVE_Z_DELTA_IN,
 FUI_TEXT_JERK_IN,
 FUI_TEXT_ZJERK_IN,
 FUI_TEXT_ACCELERATION_IN,
 FUI_TEXT_STORE_TO_EEPROM_IN,
 FUI_TEXT_LOAD_EEPROM_IN,
 FUI_TEXT_DBG_ECHO_IN,
 FUI_TEXT_DBG_INFO_IN,
 FUI_TEXT_DBG_ERROR_IN,
 FUI_TEXT_DBG_DRYRUN_IN,
 FUI_TEXT_OPS_OFF_IN,
 FUI_TEXT_OPS_CLASSIC_IN,
 FUI_TEXT_OPS_FAST_IN,
 FUI_TEXT_OPS_RETRACT_IN,
 FUI_TEXT_OPS_BACKSLASH_IN,
 FUI_TEXT_OPS_MINDIST_IN,
 FUI_TEXT_OPS_MOVE_AFTER_IN,
 FUI_TEXT_ANTI_OOZE_IN,
 FUI_TEXT_PRINT_FILE_IN,
 FUI_TEXT_PAUSE_PRINT_IN,
 FUI_TEXT_CONTINUE_PRINT_IN,
 FUI_TEXT_UNMOUNT_CARD_IN,
 FUI_TEXT_MOUNT_CARD_IN,
 FUI_TEXT_DELETE_FILE_IN,
 FUI_TEXT_FEEDRATE_IN,
 FUI_TEXT_FEED_MAX_X_IN,
 FUI_TEXT_FEED_MAX_Y_IN,
 FUI_TEXT_FEED_MAX_Z_IN,
 FUI_TEXT_FEED_MAX_Z_DELTA_IN,
 FUI_TEXT_FEED_HOME_X_IN,
 FUI_TEXT_FEED_HOME_Y_IN,
 FUI_TEXT_FEED_HOME_Z_IN,
 FUI_TEXT_FEED_HOME_Z_DELTA_IN,
 FUI_TEXT_ACTION_XPOSITION4A_IN,
 FUI_TEXT_ACTION_XPOSITION4B_IN,
 FUI_TEXT_ACTION_XPOSITION4C_IN,
 FUI_TEXT_ACTION_XPOSITION4D_IN,
 FUI_TEXT_ACTION_YPOSITION4A_IN,
 FUI_TEXT_ACTION_YPOSITION4B_IN,
 FUI_TEXT_ACTION_YPOSITION4C_IN,
 FUI_TEXT_ACTION_YPOSITION4D_IN,
 FUI_TEXT_ACTION_ZPOSITION4A_IN,
 FUI_TEXT_ACTION_ZPOSITION4B_IN,
 FUI_TEXT_ACTION_ZPOSITION4C_IN,
 FUI_TEXT_ACTION_ZPOSITION4D_IN,
 FUI_TEXT_ACTION_XPOSITION_FAST4A_IN,
 FUI_TEXT_ACTION_XPOSITION_FAST4B_IN,
 FUI_TEXT_ACTION_XPOSITION_FAST4C_IN,
 FUI_TEXT_ACTION_XPOSITION_FAST4D_IN,
 FUI_TEXT_ACTION_YPOSITION_FAST4A_IN,
 FUI_TEXT_ACTION_YPOSITION_FAST4B_IN,
 FUI_TEXT_ACTION_YPOSITION_FAST4C_IN,
 FUI_TEXT_ACTION_YPOSITION_FAST4D_IN,
 FUI_TEXT_ACTION_ZPOSITION_FAST4A_IN,
 FUI_TEXT_ACTION_ZPOSITION_FAST4B_IN,
 FUI_TEXT_ACTION_ZPOSITION_FAST4C_IN,
 FUI_TEXT_ACTION_ZPOSITION_FAST4D_IN,
 FUI_TEXT_ACTION_EPOSITION_FAST2A_IN,
 FUI_TEXT_ACTION_EPOSITION_FAST2B_IN,
 FUI_TEXT_ACTION_XPOSITION2A_IN,
 FUI_TEXT_ACTION_XPOSITION2B_IN,
 FUI_TEXT_ACTION_YPOSITION2A_IN,
 FUI_TEXT_ACTION_YPOSITION2B_IN,
 FUI_TEXT_ACTION_ZPOSITION2A_IN,
 FUI_TEXT_ACTION_ZPOSITION2B_IN,
 FUI_TEXT_ACTION_XPOSITION_FAST2A_IN,
 FUI_TEXT_ACTION_XPOSITION_FAST2B_IN,
 FUI_TEXT_ACTION_YPOSITION_FAST2A_IN,
 FUI_TEXT_ACTION_YPOSITION_FAST2B_IN,
 FUI_TEXT_ACTION_ZPOSITION_FAST2A_IN,
 FUI_TEXT_ACTION_ZPOSITION_FAST2B_IN,
 FUI_TEXT_FANSPEED_IN,
 FUI_TEXT_ACTION_FANSPEED_IN,
 FUI_TEXT_FAN_OFF_IN,
 FUI_TEXT_FAN_25_IN,
 FUI_TEXT_FAN_50_IN,
 FUI_TEXT_FAN_75_IN,
 FUI_TEXT_FAN_FULL_IN,
 FUI_TEXT_STEPPER_INACTIVE_IN,
 FUI_TEXT_STEPPER_INACTIVE2A_IN,
 FUI_TEXT_STEPPER_INACTIVE2B_IN,
 FUI_TEXT_POWER_INACTIVE_IN,
 FUI_TEXT_POWER_INACTIVE2A_IN,
 FUI_TEXT_POWER_INACTIVE2B_IN,
 FUI_TEXT_GENERAL_IN,
 FUI_TEXT_BAUDRATE_IN,
 FUI_TEXT_EXTR_STEPS_IN,
 FUI_TEXT_EXTR_START_FEED_IN,
 FUI_TEXT_EXTR_MAX_FEED_IN,
 FUI_TEXT_EXTR_ACCEL_IN,
 FUI_TEXT_EXTR_WATCH_IN,
 FUI_TEXT_EXTR_ADVANCE_L_IN,
 FUI_TEXT_EXTR_ADVANCE_K_IN,
 FUI_TEXT_EXTR_MANAGER_IN,
 FUI_TEXT_EXTR_PGAIN_IN,
 FUI_TEXT_EXTR_DEADTIME_IN,
 FUI_TEXT_EXTR_DMAX_DT_IN,
 FUI_TEXT_EXTR_IGAIN_IN,
 FUI_TEXT_EXTR_DGAIN_IN,
 FUI_TEXT_EXTR_DMIN_IN,
 FUI_TEXT_EXTR_DMAX_IN,
 FUI_TEXT_EXTR_PMAX_IN,
 FUI_TEXT_EXTR_XOFF_IN,
 FUI_TEXT_EXTR_YOFF_IN,
 FUI_TEXT_STRING_HM_BANGBANG_IN,
 FUI_TEXT_STRING_HM_PID_IN,
 FUI_TEXT_STRING_ACTION_IN,
 FUI_TEXT_HEATING_EXTRUDER_IN,
 FUI_TEXT_HEATING_BED_IN,
 FUI_TEXT_KILLED_IN,
 FUI_TEXT_STEPPER_DISABLED_IN,
 FUI_TEXT_EEPROM_STOREDA_IN,
 FUI_TEXT_EEPROM_STOREDB_IN,
 FUI_TEXT_EEPROM_LOADEDA_IN,
 FUI_TEXT_EEPROM_LOADEDB_IN,
 FUI_TEXT_UPLOADING_IN,
 FUI_TEXT_PAGE_BUFFER_IN,
 FUI_TEXT_PAGE_EXTRUDER_IN,
 FUI_TEXT_PAGE_EXTRUDER1_IN,
 FUI_TEXT_PAGE_EXTRUDER2_IN,
 FUI_TEXT_PAGE_EXTRUDER3_IN,
 FUI_TEXT_PAGE_BED_IN,
 FUI_TEXT_SPEED_MULTIPLY_IN,
 FUI_TEXT_FLOW_MULTIPLY_IN,
 FUI_TEXT_SHOW_MEASUREMENT_IN,
 FUI_TEXT_RESET_MEASUREMENT_IN,
 FUI_TEXT_SET_MEASURED_ORIGIN_IN,
 FUI_TEXT_ZCALIB_IN,
 FUI_TEXT_SET_P1_IN,
 FUI_TEXT_SET_P2_IN,
 FUI_TEXT_SET_P3_IN,
 FUI_TEXT_CALCULATE_LEVELING_IN,
 FUI_TEXT_LEVEL_IN,
 FUI_TEXT_EXTR_WAIT_RETRACT_TEMP_IN,
 FUI_TEXT_EXTR_WAIT_RETRACT_UNITS_IN,
 FUI_TEXT_SD_REMOVED_IN,
 FUI_TEXT_SD_INSERTED_IN,
 FUI_TEXT_PRINTER_READY_IN,
 FUI_TEXT_PRINTTIME_DAYS_IN,
 FUI_TEXT_PRINTTIME_HOURS_IN,
 FUI_TEXT_PRINTTIME_MINUTES_IN,
 FUI_TEXT_PRINT_TIME_IN,
 FUI_TEXT_PRINT_FILAMENT_IN,
 FUI_TEXT_PRINTED_IN,
 FUI_TEXT_POWER_IN,
 FUI_TEXT_STRING_HM_DEADTIME_IN,
 FUI_TEXT_STRING_HM_SLOWBANG_IN,
 FUI_TEXT_STOP_PRINT_IN,
 FUI_TEXT_Z_BABYSTEPPING_IN,
 FUI_TEXT_CHANGE_FILAMENT_IN,
 FUI_TEXT_WIZ_CH_FILAMENT1_IN,
 FUI_TEXT_WIZ_CH_FILAMENT2_IN,
 FUI_TEXT_WIZ_CH_FILAMENT3_IN,
 FUI_TEXT_CLICK_DONE_IN,
 FUI_TEXT_AUTOLEVEL_ONOFF_IN,
 FUI_TEXT_SERVOPOS_IN,
 FUI_TEXT_IGNORE_M106_IN,
 FUI_TEXT_WIZ_REHEAT1_IN,
 FUI_TEXT_WIZ_REHEAT2_IN,
 FUI_TEXT_WIZ_WAITTEMP1_IN,
 FUI_TEXT_WIZ_WAITTEMP2_IN,
 FUI_TEXT_EXTRUDER_JAM_IN,
 FUI_TEXT_STANDBY_IN,
 FUI_TEXT_BED_COATING_IN,
 FUI_TEXT_BED_COATING_SET1_IN,
 FUI_TEXT_BED_COATING_SET2_IN,
 FUI_TEXT_NOCOATING_IN,
 FUI_TEXT_BUILDTAK_IN,
 FUI_TEXT_KAPTON_IN,
 FUI_TEXT_BLUETAPE_IN,
 FUI_TEXT_PETTAPE_IN,
 FUI_TEXT_GLUESTICK_IN,
 FUI_TEXT_CUSTOM_IN,
 FUI_TEXT_COATING_CUSTOM_IN,
 FUI_TEXT_LANGUAGE_IN,
 FUI_TEXT_MAINPAGE6_1_IN,
 FUI_TEXT_MAINPAGE6_2_IN,
 FUI_TEXT_MAINPAGE6_3_IN,
 FUI_TEXT_MAINPAGE6_4_IN,
 FUI_TEXT_MAINPAGE6_5_IN,
 FUI_TEXT_MAINPAGE6_6_IN,
 FUI_TEXT_MAINPAGE_TEMP_BED_IN,
 FUI_TEXT_MAINPAGE_BED_IN,
 FUI_TEXT_MAINPAGE_Z_BUF_IN,
 FUI_TEXT_MAINPAGE_MUL_EUSAGE_IN,
 FUI_TEXT_MAINPAGE_XY_IN,
 FUI_TEXT_PRINT_TIME_VALUE_IN,
 FUI_TEXT_PRINT_FILAMENT_VALUE_IN,
 FUI_TEXT_METER_PRINTED_IN,
 FUI_TEXT_STATUS_IN,
 FUI_TEXT_EMPTY_IN,
 FUI_TEXT_TEMP_SET_IN,
 FUI_TEXT_CURRENT_TEMP_IN,
 FUI_TEXT_COATING_THICKNESS_IN,
 FUI_TEXT_EXTR3_TEMP_IN,
 FUI_TEXT_EXTR4_TEMP_IN,
 FUI_TEXT_EXTR5_TEMP_IN,
 FUI_TEXT_EXTR3_OFF_IN,
 FUI_TEXT_EXTR4_OFF_IN,
 FUI_TEXT_EXTR5_OFF_IN,
 FUI_TEXT_EXTR3_SELECT_IN,
 FUI_TEXT_EXTR4_SELECT_IN,
 FUI_TEXT_EXTR5_SELECT_IN,
 FUI_TEXT_DITTO_0_IN,
 FUI_TEXT_DITTO_1_IN,
 FUI_TEXT_DITTO_2_IN,
 FUI_TEXT_DITTO_3_IN,
 FUI_TEXT_ZPROBE_HEIGHT_IN,
 FUI_TEXT_OFFSETS_IN,
 FUI_TEXT_X_OFFSET_IN,
 FUI_TEXT_Y_OFFSET_IN,
 FUI_TEXT_Z_OFFSET_IN,
 FUI_TEXT_DBG_ENDSTOP_IN, // Kusuma SCARA
 FUI_TEXT_X_ANGLE_POS_IN,
 FUI_TEXT_Y_ANGLE_POS_IN,
 FUI_TEXT_X_ANGLE_FAST_IN,
 FUI_TEXT_Y_ANGLE_FAST_IN,
 FUI_TEXT_ACTION_XROTATION4A_IN,
 FUI_TEXT_ACTION_XROTATION4B_IN,
 FUI_TEXT_ACTION_XROTATION4C_IN,
 FUI_TEXT_ACTION_XROTATION4D_IN,
 FUI_TEXT_ACTION_YROTATION4A_IN,
 FUI_TEXT_ACTION_YROTATION4B_IN,
 FUI_TEXT_ACTION_YROTATION4C_IN,
 FUI_TEXT_ACTION_YROTATION4D_IN,
 FUI_TEXT_ACTION_XFAST_ROTATION4A_IN,
 FUI_TEXT_ACTION_XFAST_ROTATION4B_IN,
 FUI_TEXT_ACTION_XFAST_ROTATION4C_IN,
 FUI_TEXT_ACTION_XFAST_ROTATION4D_IN,
 FUI_TEXT_ACTION_YFAST_ROTATION4A_IN,
 FUI_TEXT_ACTION_YFAST_ROTATION4B_IN,
 FUI_TEXT_ACTION_YFAST_ROTATION4C_IN,
 FUI_TEXT_ACTION_YFAST_ROTATION4D_IN,
 FUI_TEXT_ACTION_XROTATION2A_IN,
 FUI_TEXT_ACTION_XROTATION2B_IN,
 FUI_TEXT_ACTION_YROTATION2A_IN,
 FUI_TEXT_ACTION_YROTATION2B_IN,
 FUI_TEXT_ACTION_XFAST_ROTATION2A_IN,
 FUI_TEXT_ACTION_XFAST_ROTATION2B_IN,
 FUI_TEXT_ACTION_YFAST_ROTATION2A_IN,
 FUI_TEXT_ACTION_YFAST_ROTATION2B_IN,
 FUI_TEXT_SHOULDER_CALIB_IN,
 FUI_TEXT_ELBOW_CALIB_IN,
 FUI_TEXT_SET_SHOULDER_ORIGIN_IN,
 FUI_TEXT_SET_ELBOW_ORIGIN_IN,
 FUI_TEXT_CLOSE_ARM_IN,
 FUI_TEXT_BED_POS_IN,
 FUI_TEXT_STEP_CAL_IN,
 FUI_TEXT_BED_OFF_IN,
 FUI_TEXT_MOVEX_IN,
 FUI_TEXT_MOVEY_IN,
 FUI_TEXT_MOVEZ_IN,
 FUI_TEXT_ROTX_IN,
 FUI_TEXT_ROTY_IN,
 FUI_TEXT_ENDSTOP_X_IN,
 FUI_TEXT_ENDSTOP_Y_IN,
 FUI_TEXT_SET_BED_CENTER_IN,
 FUI_TEXT_X_STEP_IN,
 FUI_TEXT_Y_STEP_IN,
 FUI_TEXT_Z_STEP_IN,
 FUI_TEXT_E_STEP_IN,
 FUI_TEXT_SWITCH_OFF_IN,
 FUI_TEXT_MOVE_IN,
 FUI_TEXT_PREHEAT_IN,
 FUI_TEXT_ADJ_MENU_IN,
 FUI_TEXT_FILM_MENU_IN,
 FUI_TEXT_TEMP_IN
};
#define LANG_IN_TABLE translations_in
#else
#define LANG_IN_TABLE NULL
#endif // LANGUAGE_IN_ACTIVE
...
const uint8_t availableLanguages[] PROGMEM = {
	...
	11,
#endif // LANGUAGE_FI_ACTIVE
#if LANGUAGE_IN_ACTIVE // Indonesia
	12, // Indonesia
