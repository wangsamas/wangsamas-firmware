...
public:
	...
	static void rotateInSteps(int32_t x,int32_t y,float feedrate,bool waitEnd,bool check_endstop,bool pathOptimize = true); // Kusuma SCARA
	static void rotateInStepsNoCheck(int32_t x,int32_t y,float feedrate,bool waitEnd,bool check_endstop,bool pathOptimize = true); // Kusuma SCARA
#if ARC_SUPPORT
    ...
    static uint8_t queueRotation(uint8_t check_endstops,uint8_t pathOptimize, uint8_t softEndstop);	// Kusuma SCARA
    inline uint16_t calculateRotationSubSegments(uint8_t softEndstop);	// Kusuma SCARA
