...
#define UI_MATRIX_ACTIONS {UI_ACTION_HOME_ALL, UI_ACTION_TOP_MENU,       UI_ACTION_SET_ORIGIN,      UI_ACTION_NEXT,\
                           ...
                           UI_ACTION_MENU_X_ANGLE_FAST,   UI_ACTION_MENU_XPOSFAST,  UI_ACTION_DISABLE_STEPPER, UI_ACTION_BACK}
#else						// Kusuma SCARA
#define UI_MATRIX_ACTIONS {UI_ACTION_HOME_ALL, UI_ACTION_TOP_MENU,       UI_ACTION_SET_ORIGIN,      UI_ACTION_NEXT,\
                           UI_ACTION_HOME_Z,   UI_ACTION_MENU_ZPOS,      UI_ACTION_COOLDOWN,        UI_ACTION_OK,\
...
void uiCheckSlowKeys(uint16_t &action) {
    ...
    UI_KEYS_I2C_BUTTON_LOW(_BV(4),UI_ACTION_MENU_MOVE_Y+UI_ACTION_TOPMENU); // push button, connects gnd to pin
    ...
    UI_KEYS_I2C_BUTTON_LOW(_BV(7),UI_ACTION_MENU_MOVE_X+UI_ACTION_TOPMENU); // push button, connects gnd to pin
/*
