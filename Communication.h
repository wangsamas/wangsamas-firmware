...
FSTRINGVAR(tEPRZStepsPerUnit)
FSTRINGVAR(tEPRZMaxFeedrate)
FSTRINGVAR(tEPRZHomingFeedrate)
#if DRIVE_SYSTEM != DELTA
FSTRINGVAR(tEPRMaxZJerk)
FSTRINGVAR(tEPRXStepsPerUnit)
FSTRINGVAR(tEPRYStepsPerUnit)
...
FSTRINGVAR(tElbowMinAngle)			// Kusuma SCARA
FSTRINGVAR(tShoulderMaxAngle)	// Kusuma SCARA
FSTRINGVAR(tElbowMaxAngle)		// Kusuma SCARA
FSTRINGVAR(tShoulderBedCenterAngle)	// Kusuma SCARA
FSTRINGVAR(tElbowBedCenterAngle)	// Kusuma SCARA
#endif								// Kusuma SCARA
